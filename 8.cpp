...
cout<<"Bienvenid@!\n"<<endl;
cout<<"Ingrese el numero de alumnos del curso: "; cin>>alum;
cout<<""<<endl;
for(i=1;i<=alum;i++){
...
cin>>peso;
	...
	cout<<"La catidad de alumnos con peso menor que 40kg es de: "<<a<<endl;
	cout<<"\nLa cantidad de alumnos con peso entre 40kg y 50kg es de: "<<b<<endl;
	cout<<"\nLa cantidad de alumnos con peso entre 50kg y 60kg es de: "<<c<<endl;
	cout<<"\nLa cantidad dealumnos con peso mayor a 60kg es de: "<<d<<endl;
}
